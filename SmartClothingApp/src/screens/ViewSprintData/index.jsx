...
const ViewSprintData = ({ route }) => {
  const { previousScreenTitle } = route.params;
  return (
    <ScrollView>
      <AppHeader title={previousScreenTitle} back={true} />
      <DailyMetrics name="Sprint Data" />

      <View style={styles.title}>
        <View style={styles.bigIcon}>
          <Icon name="running" size={40} color={AppColor.primary} />
        </View>
        <Text style={styles.dataText}>Sprint Intensity & Distance</Text>
      </View>
