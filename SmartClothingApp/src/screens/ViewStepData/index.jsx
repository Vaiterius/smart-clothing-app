...
const ViewStepData = ({ route }) => {
  const { previousScreenTitle } = route.params;
  return (
    <ScrollView>
      <AppHeader title={previousScreenTitle} back={true} />
      <DailyMetrics name="Step Data" />

      <View style={styles.title}>
        <View style={styles.bigIcon}>
          <Icon name="walking" size={40} color={AppColor.primary} />
        </View>
      ...
      <View style={styles.metricsContainer}>
        <View style={styles.metricRow}>
          <View style={styles.metricItem}>
            ...
            <Text style={styles.metricValue}>0:39:50</Text>
          </View>
          <View style={styles.metricItem}>
            <Text style={styles.metricTitle}>Distance</Text>
            <Text style={styles.metricValue}>2.78 MI</Text>
          </View>
        </View>
        <View style={styles.metricRow}>
          <View style={styles.metricItem}>
            <Text style={styles.metricTitle}>Active Calories</Text>
            <Text style={styles.metricValue}>103 CAL</Text>
          </View>
          <View style={styles.metricItem}>
        ...
        <View style={styles.metricRow}>
          ...
          <View style={styles.metricItem}>
            <Text style={styles.metricTitle}>Avg. Pace</Text>
            <Text style={styles.metricValue}>22'11''/MI</Text>
          </View>
        </View>
      </View>
    </ScrollView>
